...
$ligne = static function (array $utilisateur, string $actions): string {
    return '<li class="tile flex-hz">'
        ...
        . '<span class="friend-actions flex-hz end">' . $actions . '</span>'
        . '</li>';
};
...
<section class="card">
    <h2>Add</h2>
    <form class="form-inline" method="get" action="/friends">
        ...
        <p class="flex-hz"><button type="submit">Search</button></p>
    </form>
    ...
    <p class="note">No account named like that.</p>
        <?php else: ?>
    <ul class="friends-list flex-vt list-plain">
